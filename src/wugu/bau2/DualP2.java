...
public class DualP2 extends Position2
{
	...
	public static final int MIRROR_Z_L = -1;
	...
	public HashMap<Integer, Position2> clones = new HashMap<>();
	...
	public DualP2(Position2 source, Vector3f normal, Vector2f texCoord)
	{
		super(source, normal, texCoord);
	}
	...
	public Position2 createClone(int type, BoneC2... boneC1)
	{
		...
		else switch(type)
		{
			case MIRROR_X:
				...
				texCoord1 = new Vector2f(mirror(texCoord.x), texCoord.y);
				break;
			case MIRROR_Z:
				position1 = new Vector3f(position.x, position.y, -position.z);
				normal1 = new Vector3f(normal.x, normal.y, -normal.z);
				texCoord1 = new Vector2f(mirror(texCoord.x + 0.5f), texCoord.y);
				break;
			case MIRROR_Z_L:
				position1 = new Vector3f(position.x, position.y, -position.z);
				normal1 = new Vector3f(normal.x, normal.y, -normal.z);
	...
	{
		return (int) (x * 2) + 0.5f - x;
	}

	public DualP2 setBind(int boneBind)
	{
