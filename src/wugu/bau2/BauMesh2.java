...
public class BauMesh2
{
	...
	public ArrayList<Index3> indexes = new ArrayList<>();
	protected ArrayList<Vector3f> normals = new ArrayList<>();
	protected ArrayList<Vector2f> texCoord = new ArrayList<>();
	protected ArrayList<Byte> bIndices = new ArrayList<>();
	protected ArrayList<Float> bWeights = new ArrayList<>();
	protected int maxNumW = 1;

	protected void fertig(Mesh mesh, Vector2f texScale)
	{
		...
		mesh.scaleTextureCoordinates(texScale);
		mesh.updateBound();
