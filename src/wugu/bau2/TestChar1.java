...
{
	public TestChar1(String name)
	{
		super(name, Vector2f.UNIT_XY);
	}
	...
	protected void setup()
	{
		...
		AutoNumBone b2 = new AutoNumBone(boneList, Vector3f.UNIT_X, /*new Quaternion().fromAngleAxis(1, Vector3f.UNIT_X)*/Quaternion.IDENTITY, b1);
		...
		bau.indexQ(false, p1);
		bau.indexQ(true, p2);
		bau.cylinderTex1DP(null, false, p1, p2);
		for(Bone b : boneList)
